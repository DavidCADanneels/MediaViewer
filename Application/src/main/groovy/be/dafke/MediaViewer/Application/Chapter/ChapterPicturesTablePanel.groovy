...
class ChapterPicturesTablePanel extends JScrollPane implements ListSelectionListener {
    ChaptersOverviewDataModel dataModel
    JTable overviewTable
    ChaptersPicturesOverviewPanel chaptersOverviewPanel

    ChapterPicturesTablePanel(ChaptersPicturesOverviewPanel chaptersOverviewPanel) {
