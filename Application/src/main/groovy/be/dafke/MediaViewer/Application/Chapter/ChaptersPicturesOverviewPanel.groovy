...
class ChaptersPicturesOverviewPanel extends JPanel {
    JButton addChapterButton, addMediaToChapterButton
    ChapterPicturesTablePanel chapterTablePanel
    ChapterPicturesPanel chapterPanel
    Story story
    Chapter selectedChapter

    ChaptersPicturesOverviewPanel() {
        setLayout(new BorderLayout())

        chapterTablePanel = new ChapterPicturesTablePanel(this)
        chapterPanel = new ChapterPicturesPanel()
